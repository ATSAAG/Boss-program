...
public partial class player : CharacterBody2D
{
	...
	//Utiliser un attribut de player dans d'autres classes
	public static player player_object;
...
            }
	...
	{
		GD.Print(body.Name);
		if ((body.Name == "RunningFrog" || body.Name == "SniperFrog" || body.Name == "boss" || body.Name == "boss_2"))
		{
